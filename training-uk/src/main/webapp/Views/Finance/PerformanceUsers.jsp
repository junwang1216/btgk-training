...
<layout:override name="<%=Blocks.BLOCK_HEADER_SCRIPTS%>">
    <script type="text/javascript" src="Content/js/require.js?v=${static_resource_version}"
            data-main="Content/js/app/finance/performanceUsers.js?v=${static_resource_version}"></script>
</layout:override>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-block">
                            <input type="hidden" id="current_venue_id" value="${conditions.venueId}">
                        ...
                        <div class="card-block">
                            <div class="card">
                                <div class="card-header">
                                    <strong class="venue-title">所有基地</strong>
                                    ...
                                    <div class="card-actions">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item <c:if test="${conditions.venueId == 0}">active</c:if>"
                                                href="/admin/finance/performance?busType=${conditions.busType}&venueId=0">所有基地</a>
                                            <c:forEach var="venue" items="${orgFinanceVenuesList}">
                                                ...
                                                <c:if test="${venue.id != conditions.venueId}">
                                                    <a class="dropdown-item"
                                                       href="/admin/finance/performance?busType=${conditions.busType}&venueId=${venue.id}">${venue.venueName}</a>
                                                </c:if>
                                            </c:forEach>
                                        </div>
                                        <a href="/admin/finance/performance?venueId=-1" class="btn-direction" title="基地业绩排名">
