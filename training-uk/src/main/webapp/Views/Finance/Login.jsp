...
<layout:override name="<%=Blocks.BLOCK_HEADER_SCRIPTS%>">
    <script type="text/javascript" src="Content/js/require.js?v=${static_resource_version}"
            data-main="Content/js/app/finance/login.js?v=${static_resource_version}"></script>
</layout:override>
                ...
                <div class="card-group mb-0">
                    <div class="card p-4">
                        <div class="card-block">
                            ...
                            <form id="login_form" action="" method="post" novalidate onclick="return false;">
