                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                            <div class="btn-toolbar justify-content-between" role="toolbar">
                                ...
                                <div class="btn-group" data-toggle="buttons">
                                    <label class="btn btn-outline-secondary <c:if test="${conditions.busType == 0}">active</c:if> ">
                                        <input type="radio" name="total_bus_type" id="total_bus_type0" value="0"
                                               <c:if test="${conditions.busType == 0}">checked</c:if> >全部业务
                                    </label>
                                            ...
                                            <c:forEach var="venue" items="${orgFinanceVenuesList}">
                                                ...
                                                <c:if test="${venue.id != conditions.venueId}">
                                                    <a class="dropdown-item"
                                                       href="/admin/finance/performance?venueId=${venue.id}">${venue.venueName}</a>
                                                </c:if>
                                            </c:forEach>
                                        </div>
                                    </div>
