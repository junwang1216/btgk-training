...
<layout:override name="<%=Blocks.BLOCK_HEADER_SCRIPTS%>">
    <script type="text/javascript" src="Content/js/require.js?v=${static_resource_version}"
            data-main="Content/js/app/data/operationFinanceChart.js?v=${static_resource_version}"></script>
</layout:override>
                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                            <div class="row">
                                <div class="col-md-6">
                                    <p>流水完成情况</p>
                                    <div id="data_flow_chart" class="chart"  style="width: 100%;height:500px;"></div>
                                </div>
                                <div class="col-md-6">
                                    <p>确认收入完成情况</p>
                                    <div id="data_income_chart" class="chart"  style="width: 100%;height:500px;"></div>
                                </div>
                            </div>
                        </div>
                    </div>
...
<c:import url="../Shared/GeneralLayout.jsp">
    ...
    <c:param name="subMenu" value="finance_chart"/>
</c:import>
