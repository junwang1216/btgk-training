...
import com.training.core.common.constant.IDBConstant;
...
public class DateUtil {
    ...
    public static String getAddMonth(String month) {
        Calendar c = Calendar.getInstance();
        c.setTime(new Date());
        c.add(Calendar.MONTH, com.training.core.common.util.StrUtil.objToInt(month));
    ...
    public static List<String> getDateScopeByWeek(String startDateStr, String endDateStr, String weeks, String format) throws ParseException{
        ...
        while (dateToDate(startCal.getTime()).before(dateToDate(endCal.getTime()))) {
            ...
            if(weekList.contains(com.training.core.common.util.StrUtil.objToStr(getWeek(date)))){
    ...
    public static int getYearDay(String year){
        Calendar cal = Calendar.getInstance();
        cal.set(Calendar.YEAR, com.training.core.common.util.StrUtil.objToInt(year));
