...
public class SQLUtil {
            ...
            for(int i = 0; i < paramObj.length; i++){
                ...
                if(paramValue != null) {
                	if(paramValue.toString().matches("\\d*")){
                		...
                		list.add(com.training.core.common.util.StrUtil.trim(paramValue.toString()));
                	}
                }
            }
    ...
    public static Map getInToSQL(String inKey, String paramStrs){
        return getInToSQL(inKey, com.training.core.common.util.StrUtil.isNotBlank(paramStrs) ? paramStrs.split(",") : null);
    }
