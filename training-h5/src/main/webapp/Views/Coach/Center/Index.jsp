    ...
    <div class="page__bd">
        <div class="center-profile">
            <div class="weui-form-preview">
                <a href="/mobile/center/profile" class="weui-form-preview__bd center-header">
                ...
                <div class="weui-form-preview__ft">
                    <a class="weui-form-preview__btn weui-form-preview__btn_primary"
                       href="/mobile/center/attendance">每日签到</a>
        ...
        <div class="weui-cells center-list">
            <a class="weui-cell weui-cell_access" href="/mobile/center/class">
        ...
        <p class="weui-btn-area">
            <a href="#" class="weui-btn weui-btn_warn">退出登录</a>
        </p>
