...
<layout:override name="<%=Blocks.BLOCK_HEADER_CSS%>">
    <link href="/Content/dest/css/apply/detail.min.css?ver=${static_resource_version}" rel="stylesheet">
</layout:override>
...
<layout:override name="<%=Blocks.BLOCK_BODY%>">
    <div class="page__bd">
        ...
        <p class="weui-btn-area">
            <a href="/student/apply/confirm" class="weui-btn weui-btn_primary">我要报名</a>
        </p>
    </div>
</layout:override>
